$(document).ready(function() {
    ...
    $(".follow").click(function() {
        $(this).text(function() {
         ...
         $.ajax({
            type: "GET",
            url: "http://localhost/answer_me/home.php/SearchPage/follow",
            data: {
                courseID: $("#courseid").val(),
                flag: follow1
            },
