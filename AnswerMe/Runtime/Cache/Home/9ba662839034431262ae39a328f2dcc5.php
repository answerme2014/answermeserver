  ...
  <body>  
    ...
    <div id="content" class="container">
      ...
      <?php if(is_array($courses)): $i = 0; $__LIST__ = $courses;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$course): $mod = ($i % 2 );++$i;?><div class="bookDiv">
          <a href="/answer_me/home.php/CoursePage/index/cid/<?php echo ($course["cid"]); ?>/version/<?php echo ($course["version"]); ?>">
      ...
      <div id=btnComplete>
        <button id="btnComplete" type="button" class="btn btn-primary btn-lg col-sm-offset-5">完成</button>
      </div>
    </div>
    <!-- jQuery 的js -->
